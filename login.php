...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($username_err) && empty($password_err)) {
        ...
        $dbl = "SELECT id, username, password FROM users WHERE username = ?";
        
        if($stmt = $mysqli->prepare($dbl)){
            // Define parameter
    ...
    if(($username_err) || ($password_err)) {
        $url_errors = urlencode("usernameerr=".$username_err."&passworderr=".$password_err);
        $location = "index_login.php?".$url_errors;
